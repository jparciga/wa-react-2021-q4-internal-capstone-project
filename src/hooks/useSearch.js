...
const useSearch = ({pageSize, searchTerm }) => {
    ...
    const mapFunction = ({id, data: { name, category: { slug }, mainimage: { url }, short_description, price, stock }}) => { 
        return { id, name, url, "category": slug, shortDescription: short_description, price, stock }; 
    };
